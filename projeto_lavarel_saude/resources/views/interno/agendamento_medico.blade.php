        ...
        <div class="w-100 m-5 d-flex flex-column justify-content-center align-items-center">
            ...
            <form action="" class="w-50">
                <div class="row m-0 mb-3">
                    <div class="col-6">
                        <input type="text" class="inputs-agendamento w-100" placeholder="Horário: 00:00">
                    </div>
                    <div class="col-6">
                ...
                <div class="row m-0 mb-3">
                    <div class="col-12">
                        <input type="text" class="inputs-agendamento w-100" placeholder="Nome do paciente">
                    </div>
                </div>
                <div class="row m-0 mb-3">
                    <div class="col-12">
                        <input type="text" class="inputs-agendamento w-100" placeholder="Telefone/Celular">
                    </div>
                </div>
                <div class="row m-0 mb-3">
                    <div class="col-12">
                        <input type="text" class="inputs-agendamento w-100" placeholder="Data de nascimento">
                    </div>
                </div>
                <div class="row m-0 mb-3">
                    <div class="col-12">
                ...
                <div class="row m-0 mb-3">
                    <div class="col-12">
                        <button class="btn-blue-login w-100">Confirmar agendamento</button>
                    </div>
                </div>
            </form>
        </div>
