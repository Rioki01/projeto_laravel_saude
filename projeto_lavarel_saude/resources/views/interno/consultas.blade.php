            ...
            <div class="area-medico-consulta p-2 d-flex justify-content-between align-itemns-center mb-3">
                <div class="d-flex align-itemns-center">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h3 class="m-0">Nome do Médico</h3>
                        <p class="m-0 my-1">Especialidade: Especialidade do médico</p>
                        <p class="m-0">04/06/2024  - 14:30h</p>
                    </div>
                </div>
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <a href="{{ route('interno.consulta') }}"><button class="btn-blue-agendar mx-4">Ver informações</button></a>
                </div>
            </div>
        </div>
    </div>
